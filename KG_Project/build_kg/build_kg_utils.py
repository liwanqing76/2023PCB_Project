...
# graph.delete_all()
#
# with open(r'C:\Users\LWQ\Desktop\liwanqing\ER\entity extraction\KBQA-for-Diagnosis-main\knowledge_extraction\yes.csv','r', encoding='utf-8') as f:
#     reader = csv.reader(f)
#     data = list(reader)
# print(data[1])
# # #['0', '远距离导航', '工作频率', '3kHz~300kHz']
# for i  in  range(1,len(data)):
#     node1 = Node('head',id = data[i][1])
#     # node2 = Node('relation', id=data[i][2])
#     node3= Node('tail', id=data[i][3])
#     # relation = Node('head',name = data[i][1])
#     # relation1 = Node('relation',name = data[i][2])
#     # relation2 = Node('tail',name = data[i][3])
#     graph.create(node1)
#     # graph.create(node2)
#     graph.create(node3)
...
#
#      # major  = Relationship(data[i][1]),'方向',relation)
...
#     # graph.create(url)
#     if data[i][2]=='工作频率':
#         major = Relationship(data[i][1], '工作频率', data[i][3])
...
#         self.export_data(self.diseases,'./graph_data/head.json')
...
#     path = r"C:\Users\LWQ\Desktop\liwanqing\ER\entity extraction\KBQA-for-Diagnosis-main\knowledge_extraction/yes.csv"
